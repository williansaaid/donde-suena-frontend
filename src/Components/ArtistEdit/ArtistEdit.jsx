...
import { editArtistSchema } from "../../schemas/artistEdit";
import { useNavigate } from "react-router-dom";
import { editArtistForm } from "../../Redux/Slices/Session/sessionActions";
...
const ArtistEditForm = () => {
    ...
    const onSubmit = (values, actions) => {
        ...
        try {
            dispatch(editArtistForm(formValues, id));
            setSuccess(false);
            actions.resetForm();
    ...
    return (
        <div className="h-full w-full flex flex-col items-center justify-center bg-customGray font-source-sans rounded-3xl">
            <div className="flex border-2 bg-gray-400 w-52 h-52 items-center justify-center rounded-full overflow-hidden mt-8">
                <img src={image || "https://res.cloudinary.com/ds41xxspf/image/upload/v1669140075/Donde-Suena-Assets/user_snefch.png"} className="object-cover w-full h-full"/>
            </div>
            <form
