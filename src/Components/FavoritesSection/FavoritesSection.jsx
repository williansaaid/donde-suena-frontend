    ...
    return (
        <div>
            <div class="relative max-w-md mx-auto bg-white dark:bg-slate-800 ring-1 ring-slate-900/5">
                <div class="top-0 left-0 right-0 px-4 py-3 flex items-center font-semibold text-sm text-slate-900 dark:text-slate-200 bg-slate-50/90 dark:bg-slate-700/90 backdrop-blur-sm ring-1 ring-slate-900/10 dark:ring-black/10">
                    Artists
                </div>
