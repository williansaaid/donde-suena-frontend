                    ...
                    return (
                        <div className="min h-50 bg-gray-200 flex items-center justify-center gap-5 ">
                            ...
                            <div className="flex-grow pl-3 mr-10 bg-customWhite">
                             ...
                             <p className="mt-3 text-gray-700 text-sm ml-1 pb-5">{el.description}</p>
                            
                             <div class="content-center  m-auto max-w-sm ml-29  gap-4  ">
                             <img src={el.image?el.image:null} alt="post  "/>
