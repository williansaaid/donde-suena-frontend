    ...
    return (
        <section class="text-gray-700 body-font overflow-hidden bg-white">
            <div class="lg:w-3/1 mx-1 flex">
                <div class="object-contain  w-150 mt-6 space-y-4">
                  <div class= "relative">
                    <img
                        alt="event"
                        class=" object cover rounded border border-gray-200 px-8 border-transparent"
                        src={detail.image}
                    />
                    ...
                    <img
                        alt="event"
                        class="rounded border border-gray-200 px-8 border-transparent"
                ...
                <div class="lg:w-1/2 lg:pl-5 lg:py-10 lg:mt-6 bg-gray-300 rounded-lg">
                 <h2 class="font-bold text-xl text-center">Nombre del concierto</h2>
