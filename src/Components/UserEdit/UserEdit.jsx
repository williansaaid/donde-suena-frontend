...
const UserEditForm = () => {
    ...
    const [id] = useState(userId.uid ? userId.uid : userId.id);
    ...
    return (
        <div className="h-full w-full flex flex-col items-center justify-center bg-customGray font-source-sans rounded-3xl">
            <div className="flex border-2 bg-gray-400 w-52 h-52 items-center justify-center rounded-full overflow-hidden mt-8">
                <img src={userId.image || "https://res.cloudinary.com/ds41xxspf/image/upload/v1669140075/Donde-Suena-Assets/user_snefch.png"} className="object-cover w-full h-full" alt="" />
            </div>
            <form
